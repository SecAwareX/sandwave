<div class="row">
	<div class="col-md-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
            	<h2>iQuest | <small>Client toevoegen</small></h2>
            ...
            <a href="{baseURL}clients" class="btn btn-info" role="button" aria-pressed="true"><i class="fa fa-home"></i>&nbsp;&nbsp;Terug naar Clienten</a><br><br>
	            ...
	            <div class="alert alert-danger" role="alert">
     			 ...
     			 <form class="form-horizontal form-label-left input_mask" method="POST" action="{baseURL}addclient">
                     ...
                     <hr style="width: 100%; color: #337ab7; height: 1px; background-color:#337ab7;" />
                      ...
                      <br />
                      <button type="submit" class="btn btn-primary" name="doAddClient" {doAdd_dis}>Voeg client toe</button>
                      <a class="btn btn-primary {change_dis}" href="{baseURL}changeclient/{newClientID}" role="button">Client wijzigen</a>
     			 </form>
            </div>
        </div>
	</div>
