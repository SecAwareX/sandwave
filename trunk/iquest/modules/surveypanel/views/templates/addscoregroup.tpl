            ...
            <div class="x_content">
             <a href="{baseURL}changeform/{formID}/#Scores" class="btn btn-info" role="button" aria-pressed="true"><i class="fa fa-home"></i>&nbsp;&nbsp;Terug naar Vragenlijst</a><br><br>
	            ...
	            <div class="alert alert-danger" role="alert">
     			...
     			<form class="form-horizontal form-label-left input_mask" method="POST" action="{baseURL}addscoregroup/{formID}">
					...
					<div class="col-md-3 col-sm-3 col-xs-6 form-group buttonGroup">
						<button type="submit" class="btn btn-primary" name="addscoregroup">Voeg scoregroep toe</button>
					</div>
				</form>
            </div>
        </div>
