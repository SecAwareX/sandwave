            ...
            <div class="x_content">
             <a href="{baseURL}forms" class="btn btn-info" role="button" aria-pressed="true"><i class="fa fa-home"></i>&nbsp;&nbsp;Terug naar Vragenlijsten</a><br><br>
	            ...
	            <div class="alert alert-danger" role="alert">
     			...
     			<form class="form-horizontal form-label-left input_mask" method="POST" action="{baseURL}changequestion/{formID}">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback answerOptionsDiv">
						<label>Kies antwoord opties</label>
						<select class="form-control" id="answerOptions" name="f_answerOptions">
							{answerOptions}
						</select>
					</div>
