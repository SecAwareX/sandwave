<div class="row">
	<div class="col-md-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
            	<h2>iQuest | <small>Gebruiker toevoegen</small></h2>
       ...
       <form method="post" action="{baseURL}adduser">
  ...
  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
    ...
    <input type="text" class="form-control" id="inlineFormInputGroup" placeholder="Wachtwoord" name="f_Pass" value="{Field_pass}" readonly>
  </div>

  <div class="form-check mb-2 mr-sm-2 mb-sm-0">
    <label class="form-check-label">
      <input class="form-check-input" type="checkbox" name="doMail" {checked}> Mail de login gegevens aan de nieuwe gebruiker
    </label>
  </div>

  <button type="submit" class="btn btn-primary" name="doAddUser" {doAdd_dis}>Voeg gebruiker toe</button>
  <a class="btn btn-primary {change_dis}" href="{baseURL}changeuser/{newUserID}" role="button">Gebruiker wijzigen</a>
</form>
            </div>
        </div>
	</div>
