<div class="row">
	<div class="col-md-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
            	<h2>iQuest | <small>Bedrijf wijzigen</small></h2>
       ...
       <form method="post" action="{baseURL}changecompany/{CompanyID}">
  ...
  <div class="input-group mb-2 mr-sm-2 mb-sm-0">
   ...
   <button type="submit" class="btn btn-primary" name="doChangeCompany" {doAdd_dis}>Wijzig bedrijfsnaam</button>
</form>
            </div>
        </div>
	</div>
