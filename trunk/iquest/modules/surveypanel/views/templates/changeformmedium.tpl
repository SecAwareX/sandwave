				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane" id="Scores">
						<div class="x_panel">
							...
							<hr>
							<a class="btn btn-primary {step2_dis}" href="{baseURL}addscoregroup/{formID}" role="button">Voeg Scoregroep toe</a>
								<table class="table table-striped">
			  					<thead>
			    					<tr>
								    	<th scope="col">ScoreGroepID</th>
								      	<th scope="col">Groepnaam</th>
								      	<th scope="col">Start vraag range</th>
								     	<th scope="col">Eind vraag range</th>
								     	<th scope="col"></th>
			   						 </tr>
			  					</thead>
			  					<tbody>
